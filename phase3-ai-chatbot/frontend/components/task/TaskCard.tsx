    ...
    >
      <div className="flex items-start gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            className="w-10 h-10 flex items-center justify-center rounded-xl bg-indigo-500/5 border border-indigo-500/20 hover:border-indigo-500/50 text-indigo-400 hover:text-indigo-300 transition-all duration-200"
          ...
          <button
            className="w-10 h-10 flex items-center justify-center rounded-xl bg-rose-500/5 border border-rose-500/20 hover:border-rose-500/50 text-rose-500 hover:text-rose-400 transition-all duration-200"
