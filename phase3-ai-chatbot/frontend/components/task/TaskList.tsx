  ...
  if (error) {
    return (
      ...
      >
        ...
        <p className="text-lg text-gray-300 text-center font-medium mb-6">
          Unable to load tasks. Please check your connection.
        </p>
        {onRetry && (
          <button
            className="px-8 py-3 bg-indigo-600 text-white rounded-xl hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-600/20 transition-all duration-300 font-bold"
            onClick={onRetry}
